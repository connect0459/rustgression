...
mod tests {
    ...
    mod validate_finite_array {
        ...
        #[test]
        fn test_rejects_nan_with_error_indicating_index() {
        ...
        #[test]
        fn test_rejects_positive_infinity_with_error_indicating_index() {
        ...
        #[test]
        fn test_rejects_negative_infinity_with_error_indicating_index() {
        ...
        #[test]
        fn test_accepts_subnormal_numbers_without_error() {
    ...
    mod safe_divide {
        ...
        #[test]
        fn test_rejects_zero_denominator_with_error() {
        ...
        #[test]
        fn test_rejects_near_zero_denominator_with_error() {
        ...
        #[test]
        fn test_rejects_nan_in_numerator_with_error() {
        ...
        #[test]
        fn test_rejects_nan_in_denominator_with_error() {
        ...
        #[test]
        fn test_rejects_infinite_numerator_with_error() {
        ...
        #[test]
        fn test_rejects_infinite_denominator_with_error() {
        ...
        #[test]
        fn test_rejects_division_that_would_overflow() {
        ...
        #[test]
        fn test_includes_context_string_in_error_message() {
